...
#
# Uruchamianie:
#   python3 main.py                          (z wnętrza pizzeria_engine/)
#   python3 -m pizzeria_engine.main     (z katalogu nadrzędnego)
...
from pizzeria_engine.pizza import Pizza, Menu
from pizzeria_engine.customer import Customer, VIPCustomer, CustomerManager
from pizzeria_engine.order import Order, OrderManager
from pizzeria_engine.exceptions import (
    PizzeriaError,
    InvalidPriceError,
    PizzaNotFoundError,
